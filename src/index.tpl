...
<body>
    ...
    {% for chal in chals %}
        <div class="problem-container-div" id="{{ chal['id'] }}-problem-div"
            ...
            <div class="challenge-title-div">
                ...
                <span class="subtitle-span">{{ chal['subtitle'] }}</span>
            </div>
            <a class="difficulty-rating">{{ chal['difficulty'] }}</a> 
        </div>
    {% endfor %} 
    </div>
    ...
    <span class="info-bottomtext">This website made by <a href="https://franklin.dyer.me/">Franklin Pezzuti Dyer</a>. <br> I'm open source - check out my <a href="https://github.com/franklindyer/r-stat-challenges">code on Github!</a></span>
</body>
</html>
